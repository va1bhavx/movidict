      ...
      <div className="grid grid-cols-2 gap-x-6 gap-y-5 sm:grid-cols-3 lg:gap-x-8">
        {cast.map((_, index) => (
          <div key={index} className="group flex min-w-0 items-center gap-3">
            {/* Profile */}
            <div className="relative size-16 shrink-0 overflow-hidden rounded-full bg-neutral-900 ring-1 ring-white/10 transition-all duration-300 group-hover:ring-white/20 sm:size-[72px]">
              <Image
                src="https://image.tmdb.org/t/p/w185/cO7J0XSVKPlAjUCMWC7DVBn1Py2.jpg"
                alt="John Doe"
                fill
                sizes="72px"
